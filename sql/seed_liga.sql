-- ================================================================
-- SEED: equipos + personas + jugadores  ·  Temporada 2025-2026
...
INSERT INTO personas (nombre, apellidos) VALUES
  ...
  ('Victor', 'Hugo Lastra Estupiñan'),
  ('Alejandro', 'Pons Mayans'),
  ('Juan', 'Jose Perello Plaza'),
  ('Biel', 'Rossinyol Costa'),
  ('Miguel', 'Bou Languil'),
  ('Enric', 'Ruiz Ferretjans'),
  ('Samuel', 'Garcia Loza'),
  ('Miquel', 'Marti Hinojosa'),
  ('Antoni', 'Sanchez Juan'),
  ('J.p.p.', ''),
  ('Gaspar', 'Thomas Riera'),
  ('Jose', 'Font Molina'),
  ('Antoni', 'Pedrajas Cabrer'),
  ('Pau', 'Vicens Mascaro'),
  ('Joel', 'Montes Puerta'),
  ('Kian', 'Kohler'),
  ('Tomas', 'Gual Amengual'),
...
UNION ALL
  SELECT p.id, e.id, '2' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Victor') AND LOWER(p.apellidos)=LOWER('Hugo Lastra Estupiñan') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '4' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Alejandro') AND LOWER(p.apellidos)=LOWER('Pons Mayans') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '5' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Juan') AND LOWER(p.apellidos)=LOWER('Jose Perello Plaza') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '8' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Biel') AND LOWER(p.apellidos)=LOWER('Rossinyol Costa') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '13' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Miguel') AND LOWER(p.apellidos)=LOWER('Bou Languil') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '17' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Enric') AND LOWER(p.apellidos)=LOWER('Ruiz Ferretjans') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '21' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Samuel') AND LOWER(p.apellidos)=LOWER('Garcia Loza') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '35' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Miquel') AND LOWER(p.apellidos)=LOWER('Marti Hinojosa') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '77' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Antoni') AND LOWER(p.apellidos)=LOWER('Sanchez Juan') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '79' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('J.p.p.') AND LOWER(p.apellidos)=LOWER('') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '81' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Gaspar') AND LOWER(p.apellidos)=LOWER('Thomas Riera') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '83' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Jose') AND LOWER(p.apellidos)=LOWER('Font Molina') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '33' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Antoni') AND LOWER(p.apellidos)=LOWER('Pedrajas Cabrer') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '12' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Pau') AND LOWER(p.apellidos)=LOWER('Vicens Mascaro') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '30' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Joel') AND LOWER(p.apellidos)=LOWER('Montes Puerta') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '28' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Kian') AND LOWER(p.apellidos)=LOWER('Kohler') AND e.short_name='SAC'
UNION ALL
  SELECT p.id, e.id, '34' FROM personas p, equipos e WHERE LOWER(p.nombre)=LOWER('Tomas') AND LOWER(p.apellidos)=LOWER('Gual Amengual') AND e.short_name='SAC'
UNION ALL
